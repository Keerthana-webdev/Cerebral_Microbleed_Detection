...
STAGE1_MODEL_PATH = MODEL_DIR / "candidate_detector_v2_best.pt"   # CHANGED: use retrained v2
...
class CMBDetectionPipeline:
    ...
    def __init__(self):
        self.stage1_model = SimpleCNN3D().to(
            DEVICE
        )
        ...
        self.stage2_model = SimpleCNN3D().to(
            DEVICE
        )
