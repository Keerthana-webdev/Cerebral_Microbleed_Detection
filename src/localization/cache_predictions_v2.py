"""
Lesson 17c: Same as cache_predictions.py, but using the RETRAINED
(v2) Stage 1 model, so we can directly compare FP/subject before vs after.
"""
...
CACHE_DIR = Path(__file__).resolve().parents[2] / "data" / "localization_cache_v2"
CACHE_DIR.mkdir(parents=True, exist_ok=True)

PATCH_SIZE = (16, 16, 8)
STRIDE = (8, 8, 4)

# CHANGED: v2 candidate detector instead of the original
...
def main():
    ...
    print(f"\nAll v2 predictions cached to {CACHE_DIR}")
